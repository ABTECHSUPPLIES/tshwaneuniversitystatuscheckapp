...
function sendMessage() {
    ...
    if (chatBody) {
        ...
        // Get URL and CSRF token from data attributes
        const chatConfig = document.getElementById('chatConfig');
        const aiChatUrl = chatConfig.dataset.url;
        const csrfToken = chatConfig.dataset.csrf;
        console.log('Using updated sendMessage, URL:', aiChatUrl); // Debug log
